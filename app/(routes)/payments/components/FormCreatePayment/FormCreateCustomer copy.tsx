...
import { FormCreateCustomerProps } from './FormCreatePayment.types';
...
const formSchema = z.object({
	...
	pago: z.string().min(1, { message: 'El tipo es obligatorio.' }),
					...
					<div className="grid grid-cols-2 gap-3">
						...
						<FormField
							...
							render={({ field }) => {
								return (
									<FormItem>
										<FormLabel>Incripciones</FormLabel>
										<FormControl>
											{/* El componente Select de react-select */}
											<Select
												isMulti // Habilita la selección múltiple
