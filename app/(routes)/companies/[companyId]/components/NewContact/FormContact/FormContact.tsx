...
export function FormContact(props: FormContactProps) {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>) => {
		try {
			...
			toast({ title: 'There was an error', variant: 'destructive' });
		}
	};
	return (
		<Form {...form}>
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormControl>
								<Input placeholder="Juan Arrribas" {...field} />
							</FormControl>
							<FormMessage />
						</FormItem>
					)}
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormControl>
								<Input placeholder="+ 34 55 44 55" {...field} />
							</FormControl>
							<FormMessage />
						</FormItem>
					)}
						...
						<FormItem>
							...
							<Select onValueChange={field.onChange} defaultValue={field.value}>
								...
								<SelectContent>
									...
									<SelectItem value="Queality">Customer Service</SelectItem>
