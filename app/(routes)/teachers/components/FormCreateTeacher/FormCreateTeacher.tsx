...
import { FormCreateTeacherProps } from './FormCreateTeacher.types';
...
export function FormCreateTeacher(props: FormCreateTeacherProps) {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>) => {
		try {
			...
			const response = await axios.post('/api/teacher', formattedValues);
