...
import { FormCreateCourseProps } from './FormCreateCourse.types';
...
export function FormCreateCourse(props: FormCreateCourseProps) {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>) => {
		try {
			...
			const response = await axios.post('/api/course', formattedValues);
